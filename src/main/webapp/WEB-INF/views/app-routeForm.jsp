...
<table style="width: 100%">
    ...
    <td class="mainContent">
        <%--CONTENT-START--%>
        <h2>DODAJ TRASĘ</h2>
        <form:form method="post" modelAttribute="routeDto">
